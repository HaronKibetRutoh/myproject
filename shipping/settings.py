...
SECRET_KEY = '5qp&05iylesqtkmyd)o02d5*d3%%rbrh=h(d-^3*(1(sw57%c-'
...
STATICFILES_DIRS = (
    ...
    '/home/ruto/django-projects/myproject/env/lib/python3.8/site-packages/django/contrib/admin/static/admin/js/core.js',
)
